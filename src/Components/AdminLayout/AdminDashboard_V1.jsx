...
{activeTab === "Projet en cours" && (
  <section className="courantProject-section">
    <h2>Projets en cours</h2>
...
{isWorkerModalOpen && (
  ...
  <div className="modal-overlay">
    <div className="modal">
      ...
      <button onClick={handleUpdateWorker}>Enregistrer</button>
...
export default AdminDashboardV1;